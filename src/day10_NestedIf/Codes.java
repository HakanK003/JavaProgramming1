...
public class Codes {
    ...
    public static void main(String[] args) {
        ...
        String result = (statusCode==200||statusCode==201||statusCode==202||statusCode==301||
                        statusCode==303||statusCode==304||statusCode==307||statusCode==400||statusCode==401||
                        statusCode==403||statusCode==404||statusCode==410||statusCode==500||statusCode==503)?
        (statusCode==200)? "Ok" :(statusCode==201)? "Created" :(statusCode==202)? "Accepted"
        ...
        :(statusCode==500)? "Internal Server Error" : "Service Unavailable" : "Invalid";
