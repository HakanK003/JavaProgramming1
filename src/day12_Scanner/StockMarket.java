...
public class StockMarket {
    ...
    public static void main(String[] args) {
        ...
        int sharesAlready= input.nextInt();
        if (sharesAlready>=1){
            System.out.println("How much your total value in the stock market");
            double totalValue = input.nextDouble();
            System.out.println("What is name of the company you have the most shares in");
            input.nextLine();
            String nameCompany= input.nextLine();

            input.close();

            System.out.println("Your total stock market holding is $"+totalValue+" which is made up of "+sharesAlready+" shares. "
            + nameCompany+" is your company holdings");
